...
class ManagePublicSpotPricesbody extends StatelessWidget {
  ManagePublicSpotPricesbody({super.key});
  String? price;
  String? fees;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                    hintText: 'Additional Guest Fees',
                    onchanged: (data) {
                      fees = data;
                    },
                  ),
                  ...
                  const Text(
                    '''Note: Additional Guest Fees = Normal +Fees''',
