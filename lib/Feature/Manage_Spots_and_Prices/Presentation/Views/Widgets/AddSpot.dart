...
class AddReservableSpot extends StatelessWidget {
  AddReservableSpot({
    super.key,
  ...
  Widget build(BuildContext context) {
    ...
    return BlocConsumer<AddReservableSpotCubit, AddReservableSpotState>(
      listener: (context, state) {
        if (state is AddReservableSpotFailure) {
          CustomScaffoldMessenger(context, "Error is : ${state.errmessage}",
              FontAwesomeIcons.circleXmark);
        } else if (state is AddReservableSpotSuccess) {
            ...
            child: Column(
              ...
              children: [
                ...
                EditandDeleteButton(
                    ...
                    text: btntext,
                    onPressed: () {
                      context.read<AddReservableSpotCubit>().addreservablespot(
                          token: token,
                          spotcode: spotname!,
                          managementid: '1',
